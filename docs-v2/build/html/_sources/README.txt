...
Projeto *Cuidando do Meu Bairro*: apresentação participativa e
geolocalização do orçamento municipal.
...
Texto completo de instruções em `install-site.md <install-site.md>`__.
...
`install-services.md <install-services.md>`__. A preparação dos dados
