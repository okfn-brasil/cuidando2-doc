...
* **Financeamento**: a versão 2.0 da ferramenta, partiu da *Iniciativa Latinoamericana por los Datos Abiertos (ILDA)*, financiada pela *Fundação Avina* no contexto do *Fundo para Inovações Cívicas*.
